...
export const bookAtomicHabits = {
  ...
  pageNo: 288,
  author: "James Clear",
  genre: ["Self Help", "Motivation", "Productivity"],
  readed: "275k",
  description:
...
export const bookEverythingIsFked = {
  ...
  readed: "87k",
  description:
    "In everything is f*cked, manson turns his gaze from the inevitable flaws within each individual self to the endless calamities taking place in the world around us. Drawing from the pool of psychological research on these topics, as well as the timeless wisdom of philosophers such as Plato, Nietzsche, and Tom waits, he dissects religion and politics and the uncomfortable ways they have come to resemble one another. He looks at our relationships with money, entertainment and the Internet, and how too much of a good thing can psychologically eat us alive. He openly defies our definitions of faith, happiness, freedom even of hope itself. With his usual mix of erudition and where-the-f*ck-did-that-come-from humor, manson takes us by the collar and challenges us to be more honest with ourselves and connected with the world in ways we probably haven’t considered before. It’s another counterintuitive romp through the pain in our hearts and the stress of our soul. One of the great modern writers has produced another book that will set the agenda for years to come.",
  backgroundColor: "rgba(82, 203, 209, 0.9)",
  navTintColor: "#FFF",
};

export const bookFaultInOurStars = {
  id: 7,
  bookName: "Fault In Our Stars",
  bookCover: images.faultInOurStars,
  rating: 4.7,
  language: "Eng",
  pageNo: 352,
  author: "John Green",
  ...
  backgroundColor: "rgba(38, 161, 218, 0.9)",
  navTintColor: "#FFF",
};

export const bookFortyRulesOfLove = {
  id: 8,
  bookName: "The Forty Rules of Love",
  bookCover: images.fortyRulesOfLove,
  rating: 4.8,
  language: "Eng",
  pageNo: 368,
  author: "Elif Shafak",
  genre: ["Drama", "Romance", "History", "Fiction"],
  readed: "95k",
  description:
  ...
  backgroundColor: "rgba(201, 58, 73, 0.9)",
  navTintColor: "#FFF",
};

export const bookImmortalsOfMeluha = {
  id: 9,
  bookName: "The Immortals of Meluha",
  bookCover: images.meluha,
  rating: 4.4,
  language: "Eng",
  pageNo: 415,
  author: "Amish",
  genre: ["Drama", "Myths", "History", "Fiction"],
  readed: "323k",
  description:
  ...
  backgroundColor: "rgba(68, 80, 76, 0.9)",
  navTintColor: "#FFF",
};

export const bookSita = {
  id: 10,
  bookName: "Sita: The Warrior of Mithila",
  bookCover: images.sita,
  rating: 4.8,
  language: "Eng",
  pageNo: 366,
  author: "Amish",
...
export const bookSubtleArtOfNotGivingAFked = {
  id: 11,
  bookName: "The Subtle Art of not giving a F*ck",
  bookCover: images.subtleArt,
  rating: 4.5,
  language: "Eng",
  pageNo: 224,
  author: "Mark Manson",
...
export const bookThePalaceOfIllusions = {
  ...
  backgroundColor: "rgba(64, 122, 75, 0.9)",
  navTintColor: "#FFF",
};

export const bookWishICouldTellYou = {
  id: 13,
  bookName: "Wish I Could Tell You",
  bookCover: images.wishICouldTellYou,
  rating: 4.1,
  language: "Eng",
  pageNo: 288,
  author: "Durjoy Data",
  ...
  backgroundColor: "rgba(20, 23, 43, 0.9)",
  navTintColor: "#FFF",
};

export const bookChamberOfSecrets = {
  id: 14,
  bookName: "Harry Potter and the Chamber Of Secrets",
  bookCover: images.chamberOfSecrets,
  rating: 4.9,
  language: "Eng",
  pageNo: 384,
  author: "J.K. Rowling",
  ...
  backgroundColor: "rgba(126, 79, 88, 0.9)",
  navTintColor: "#FFF",
};

export const bookDaVinciCode = {
  id: 15,
  bookName: "The Da Vinci Code",
  bookCover: images.daVinciCode,
  rating: 4.3,
  language: "Eng",
  pageNo: 592,
  author: "Dan Brown",
...
export const bookTheHobbit = {
  ...
  backgroundColor: "rgba(220, 179, 89, 0.9)",
  navTintColor: "#FFF",
};

export const bookAshesToMagic = {
  id: 17,
  bookName: "From Ashes to Magic",
  bookCover: images.ashesToMagic,
  rating: 4.5,
  language: "Eng",
  pageNo: 306,
  author: "Mikki Noble & co",
  genre: ["Anthology", "Fantasy", "Action"],
  readed: "75k",
  description:
  ...
  backgroundColor: "rgba(11, 14, 29, 0.9)",
  navTintColor: "#FFF",
};

export const bookEgoIsTheEnemy = {
  id: 18,
  bookName: "Ego is the Enemy",
  bookCover: images.egoIsTheEnemy,
  rating: 4.8,
  language: "Eng",
  pageNo: 256,
  author: "Ryan Holiday",
  genre: ["Motivation", "Self Help", "Science"],
  readed: "975k",
  description:
  ...
  backgroundColor: "rgba(0, 65, 97, 0.9)",
  navTintColor: "#FFF",
};

export const bookElementsOfGate = {
  id: 19,
  bookName: "The Elements of the Gate",
  bookCover: images.elementsOfGate,
  rating: 5.0,
  language: "Eng",
  pageNo: 544,
  author: "Kay L Moody",
  ...
  backgroundColor: "rgba(2, 85, 68, 0.9)",
  navTintColor: "#FFF",
};

export const bookInfluence = {
  id: 20,
  bookName: "Influence:The Psychology of Persuasion",
  bookCover: images.influence,
  rating: 4.9,
  language: "Eng",
  pageNo: 608,
  author: "PhD Robert B. Cialdini",
  genre: ["Analysis", "Science", "Non Fiction"],
  readed: "975k",
  description:
...
export const bookKingdomOfCopper = {
  id: 21,
  bookName: "Kingdom of Copper",
  bookCover: images.kingdomOfCopper,
  rating: 4.4,
  language: "Eng",
  pageNo: 640,
...
export const bookMonkFerrari = {
  ...
  backgroundColor: "rgba(230, 199, 126, 0.9)",
  navTintColor: "#000",
};

export const bookNarashima = {
  id: 23,
  bookName: "Narashima:The Mahaavtar Triology",
  bookCover: images.narsimha,
  rating: 4.2,
  language: "Eng",
  pageNo: 320,
  author: "Kevin Missal",
  genre: ["Myths", "Fantasy", "Saga"],
  readed: "137k",
  description:
  ...
  backgroundColor: "rgba(110, 93, 147, 0.9)",
  navTintColor: "#FFF",
};

export const bookPerfectUs = {
  id: 24,
  bookName: "The Perfect Us",
  bookCover: images.perfectUs,
  rating: 4.6,
  language: "Eng",
  pageNo: 288,
  author: "Durjoy Datta",
  ...
  backgroundColor: "rgba(108, 15, 60, 0.9)",
  navTintColor: "#FFF",
};

export const bookPrioryOfOrangeTree = {
  id: 25,
  bookName: "The Priory of the Orange Tree",
  bookCover: images.prioryOfOrangeTree,
  rating: 4.4,
  language: "Eng",
  pageNo: 846,
  author: "Samantha Shannon",
  genre: ["Myths", "Fantasy", "Sagas"],
  readed: "337k",
  description:
  ...
  backgroundColor: "rgba(255, 212, 92, 0.9)",
  navTintColor: "#000",
};

export const bookRealmOfBeasts = {
  id: 26,
  bookName: "Realm Of Beasts",
  bookCover: images.realmOfBeasts,
  rating: 4.0,
  language: "Eng",
  pageNo: 292,
  author: "Angels J. Ford",
